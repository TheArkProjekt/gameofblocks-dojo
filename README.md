...
> In this template, we use `@gob-dojo` as a placeholder for package names. As a user, you might want to replace it with your own organization or project name. You can use find-and-replace to change all the instances of `@gob-dojo/` to something like `@my-company/` / `@project-name/`.
